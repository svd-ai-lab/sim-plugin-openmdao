...
hatchling picks it up via ``packages = ["src/sim_plugin_openmdao"]``
...
def test_wheel_contains_skills(tmp_path: Path) -> None:
    ...
    wheels = list(out_dir.glob("sim_plugin_openmdao-*.whl"))
    ...
    required = {
        "sim_plugin_openmdao/__init__.py",
        "sim_plugin_openmdao/driver.py",
        "sim_plugin_openmdao/_skills/openmdao/SKILL.md",
    }
